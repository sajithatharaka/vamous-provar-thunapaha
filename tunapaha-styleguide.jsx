    ...
    tokens: [
      {
        ...
        hex: "#E8912A",
        token: "amber-gold",
        use: "CTAs, buttons, hero accents",
      },
      {
        name: "Burnt Orange",
        hex: "#D4721A",
        token: "burnt-orange",
        use: "Gradient mid-stop, hover states",
      },
      {
        name: "Deep Ember",
        hex: "#C4621A",
        token: "deep-ember",
        use: "Gradient end, active states",
      },
    ],
  },
  secondary: {
    ...
    tokens: [
      {
        ...
        hex: "#2D5016",
        token: "curry-green",
        use: "Section backgrounds, accents",
      },
      {
        name: "Clove Brown",
        hex: "#5D3A3A",
        token: "clove-brown",
        use: "Dark headers, footer",
      },
      {
        name: "Spice Bark",
        hex: "#8B4A10",
        token: "spice-bark",
        use: "Subtext on light amber",
      },
    ],
  },
  neutral: {
    ...
    tokens: [
      {
        ...
        from: "#E8912A",
        to: "#C4621A",
        token: "gradient-amber",
        use: "Hero panel, Harshika card, CTA buttons",
      },
      {
        name: "Spice Field",
        from: "#D4A574",
        to: "#2D5016",
        token: "gradient-spice",
        use: "Hero title text, badge backgrounds",
      },
      {
        name: "Sunset Yellow",
        from: "#FFF3DC",
        to: "#FFD878",
        token: "gradient-yellow",
        use: "Meet Harshika section background",
      },
      {
        name: "Deep Feast",
        from: "#1A0F0A",
...
const TYPOGRAPHY = [
  ...
  },
  {
    ...
    lh: "1.4",
    tracking: "0.08em",
    usage: "Eyebrow text, uppercase tags",
  },
];

const SPACING = [2, 4, 8, 12, 16, 20, 24, 32, 40, 48, 64, 80, 96, 128];

const COMPONENTS = ["Buttons", "Badges", "Cards", "Inputs", "Tiles"];
        ...
        >
          {[
            ...
            >
              ...
              <CopyBadge
                text={`font-family: '${f.name}', ${i === 0 ? "serif" : "sans-serif"}`}
              />
            </div>
          ))}
        </div>
    ...
    <section>
      ...
      >
        ...
        >
          ...
          >
            <strong style={{ color: "#2A2420" }}>Convention:</strong> Section
            padding <code>8rem 6rem</code> desktop · <code>5rem 2rem</code>{" "}
            mobile. Card padding <code>2–3rem</code>. Gap between grid items{" "}
            <code>2–2.5rem</code>.
          </p>
        </div>
      </div>
    ...
    <section>
      ...
      <div style={{ marginBottom: "2.5rem" }}>
        ...
        >
          {[
            {
              label: "Cook • Taste • Remember",
              bg: "linear-gradient(135deg,#E8912A,#2D5016)",
              color: "white",
            },
            {
              label: "Coming to Lisbon",
              bg: "rgba(232,145,42,0.12)",
              color: "#8B4A10",
              border: "1px solid rgba(232,145,42,0.3)",
            },
            {
        ...
        >
          ...
          <div
            style={{
              borderRadius: "20px",
              overflow: "hidden",
              border: "2px solid rgba(232,145,42,0.2)",
              boxShadow: "0 8px 32px rgba(232,145,42,0.1)",
              background: "#FFFBF5",
            }}
          >
            <div
              style={{
                height: "100px",
                background:
                  "linear-gradient(135deg,rgba(232,145,42,0.25),rgba(212,165,116,0.15))",
                display: "flex",
                alignItems: "center",
            ...
            <div style={{ padding: "1.25rem" }}>
              ...
              >
                Used for dish tiles, content cards.
              </p>
            </div>
          </div>
          ...
          <div
            style={{
              borderRadius: "20px",
              overflow: "hidden",
              background: "linear-gradient(135deg,#E8912A,#C4621A)",
          ...
          >
            <div style={{ padding: "1.75rem" }}>
              ...
              >
                Experience steps, feature highlights.
              </p>
            </div>
          </div>
          ...
          <div
            style={{
              ...
              padding: "1.75rem",
              backgroundImage: "linear-gradient(135deg,#1A0F0A,#2D5016)",
            }}
          >
            <div style={{ padding: "0" }}>
              <p
              ...
              >
                Contact form, dark section overlays.
              </p>
            </div>
          </div>
        </div>
      ...
      <div style={{ marginBottom: "2.5rem" }}>
        ...
        >
          ...
          >
            ...
            >
              &ldquo;When you eat with your hands, food tastes different. More
              truthful.&rdquo;
            </p>
          </div>
          <div
          ...
          >
            ...
            >
              &ldquo;TunaPaha means three spices—the foundation of all Sri
              Lankan cooking.&rdquo;
            </p>
          </div>
        </div>
      </div>
  ...
  return (
    <section>
      ...
      >
        ...
        >
          <strong style={{ color: "#2A2420" }}>Icon style rule:</strong> Prefer
          emoji for warmth and accessibility in consumer-facing UI. Use{" "}
          <code>lucide-react</code> (Flame, Heart, ChefHat, ArrowRight, Users,
          Sparkles, Star) for structural UI icons. Keep icon size consistent:
          48px feature icons · 24px inline · 16px badge/label.
        </p>
      </div>
    </section>
  );
      ...
      >
        ...
        <div
          style={{
            ...
            borderRadius: "16px",
            padding: "1.75rem",
            border: "1px solid rgba(196,98,26,0.15)",
          }}
        >
          <p
            style={{
...
export default function StyleGuide() {
  ...
  return (
    ...
    >
            ...
            {NAV.map((n) => (
              <button
                ...
                style={{
                  ...
                  border: "2px solid",
                  borderColor:
                    active === n ? "#E8912A" : "rgba(255,255,255,0.2)",
      ...
      {/* Content */}
      <main
        style={{ maxWidth: 1100, margin: "0 auto", padding: "4rem 4rem 6rem" }}
      >
